...
public enum BannerParameter {
    ...
    RES_NAME_FONT("res_name_font", FontFace.SOURCE_SANS_PRO, FontFace.class),
    ...
    AUT_NAME_FONT("aut_name_font", FontFace.SOURCE_SANS_PRO, FontFace.class),
    ...
    REV_COUNT_FONT("rev_count_font", FontFace.SOURCE_SANS_PRO, FontFace.class),
    ...
    DL_COUNT_FONT("dl_count_font", FontFace.SOURCE_SANS_PRO, FontFace.class),
    ...
    PRICE_FONT("price_font", FontFace.SOURCE_SANS_PRO, FontFace.class);
