...
public enum ResourceParameter implements BannerParameter<Object> {
    ...
    UPDATED_X("updated__x", 104, int.class),
    UPDATED_Y("updated__y", 62, int.class),
    UPDATED_FONT_SIZE("updated__font_size", 14, int.class),
    UPDATED_BOLD("updated__bold", false, boolean.class),
    UPDATED_TEXT_ALIGN("updated__text_align", BannerTextAlign.LEFT, BannerTextAlign.class),
    UPDATED_FONT_FACE("updated__font_face", BannerFontFace.SOURCE_SANS_PRO, BannerFontFace.class),
